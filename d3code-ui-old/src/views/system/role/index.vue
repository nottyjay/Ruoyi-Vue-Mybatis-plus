        ...
        <template slot-scope="scope" v-if="scope.row.roleId !== 1">
          ...
          >
            ...
            <el-dropdown-menu slot="dropdown">
              ...
              <el-dropdown-item command="handleAuthUserGroup" icon="el-icon-user"
                                v-hasPermi="['system:role:edit']"
              >分配用户组
              </el-dropdown-item>
            </el-dropdown-menu>
...
export default {
  ...
  methods: {
    ...
    handleCommand(command, row) {
      switch (command) {
        ...
        case 'handleAuthUser':
          ...
          break
        case 'handleAuthUserGroup':
          this.handleAuthUserGroup(row)
          break
        default:
          break
      }
     ...
     * @param row
     */
    handleAuthUserGroup(row) {
      const roleId = row.roleId
      this.$router.push('/system/role-auth/userGroup/' + roleId)
    },
    /** 提交按钮 */
    submitForm: function() {
