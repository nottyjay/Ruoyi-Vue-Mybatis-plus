package com.d3code.bpm.framework.core;
...
public class BpmParallelMultiInstanceBehavior extends ParallelMultiInstanceBehavior {
  ...
  protected int resolveNrOfInstances(DelegateExecution execution) {
    ...
    super.collectionVariable =
        FlowableUtil.formatCollectionVariable(execution.getCurrentActivityId());
    // 从 execution.getVariable() 读取当前所有任务处理的人的 key
    super.collectionElementVariable =
        FlowableUtil.formatCollectionElementVariable(execution.getCurrentActivityId());
