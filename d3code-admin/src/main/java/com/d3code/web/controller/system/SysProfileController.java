...
import com.d3code.common.utils.file.FileUploadUtils;
import com.d3code.common.utils.file.MimeTypeUtils;
...
public class SysProfileController extends BaseController {
  ...
  public AjaxResult avatar(@RequestParam("avatarfile") MultipartFile file) throws Exception {
    if (!file.isEmpty()) {
      LoginUser loginUser = getLoginUser();
      String avatar =
          FileUploadUtils.upload(D3codeConfig.getAvatarPath(), file, MimeTypeUtils.IMAGE_EXTENSION);
