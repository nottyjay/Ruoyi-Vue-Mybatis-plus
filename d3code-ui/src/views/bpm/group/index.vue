      ...
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="成员" prop="memberUserIds">
          <el-select v-model="form.memberUserIds" multiple placeholder="请选择成员">
            <el-option v-for="user in users" :key="parseInt(user.userId)" :label="user.nickName"
...
<script>
import { createUserGroup, updateUserGroup, deleteUserGroup, getUserGroup, listUserGroup } from '@/api/bpm/userGroup'
