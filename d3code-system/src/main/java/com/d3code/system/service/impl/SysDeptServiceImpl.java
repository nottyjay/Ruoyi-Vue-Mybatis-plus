package com.d3code.system.service.impl;
...
import com.d3code.common.annotation.DataScope;
import com.d3code.common.constant.UserConstants;
import com.d3code.common.core.domain.TreeSelect;
import com.d3code.common.core.domain.entity.SysDept;
import com.d3code.common.core.domain.entity.SysRole;
...
import com.d3code.common.utils.SecurityUtils;
import com.d3code.common.utils.StringUtils;
import com.d3code.common.utils.spring.SpringUtils;
import com.d3code.system.mapper.SysDeptMapper;
import com.d3code.system.mapper.SysRoleMapper;
import com.d3code.system.service.ISysDeptService;
...
public class SysDeptServiceImpl extends ServiceImpl<SysDeptMapper, SysDept>
  ...
  public void validateDeptList(Collection<Long> ids) {
    ...
    // 获得科室信息
    Map<Long, SysDept> deptMap = CollectionUtil.convertMap(deptList, SysDept::getDeptId);
    // 校验
    ids.forEach(
        id -> {
          ...
          if (!SystemStatusEnum.ENABLE.getStatus().equals(dept.getStatus())) {
            throw new ServiceException("名字为【" + dept.getDeptName() + "】的部门已被禁用");
          }
        });
  }
