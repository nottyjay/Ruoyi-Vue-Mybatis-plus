...
VALUES (1, '用户管理-账号初始密码', 'sys.user.initPassword', '123456', 'Y', 'admin', sysdate(), '', sysdate(),
        '初始化密码 123456');
INSERT INTO `sys_config`
VALUES (2, '账号自助-验证码开关', 'sys.account.captchaEnabled', 'true', 'Y', 'admin', sysdate(), 'admin',
        sysdate(), '是否开启验证码功能（true开启，false关闭）');
INSERT INTO `sys_config`
VALUES (3, '账号自助-是否开启用户注册功能', 'sys.account.registerUser', 'true', 'Y', 'admin', sysdate(), 'admin',
        sysdate(), '是否开启注册用户功能（true开启，false关闭）');
INSERT INTO `sys_config`
VALUES (4, '系统主题配置', 'sys.theme.setting',
        '{\n            \"topNav\":false,\n            \"tagsView\":true,\n            \"fixedHeader\":true,\n            \"sidebarLogo\":true,\n            \"dynamicTitle\":true,\n            \"sideTheme\":\"theme-light\",\n            \"theme\":\"#F53C0D\"\n          }',
        'Y', 'admin', sysdate(), 'admin', sysdate(), NULL);
...
VALUES (100, 0, '0', '安惠科技', 0, 1, '15888888888', 'alphay@qq.com', '0', 0, 'admin', sysdate(), '', NULL,
        NULL);
INSERT INTO `sys_dept`
VALUES (101, 100, '0,100', '南通总公司', 1, 1, '15888888888', 'alphay@qq.com', '0', 0, 'admin', sysdate(), '',
        NULL, NULL);
INSERT INTO `sys_dept`
VALUES (102, 100, '0,100', '长沙分公司', 2, 1, '15888888888', 'alphay@qq.com', '0', 0, 'admin', sysdate(), '',
        NULL, NULL);
INSERT INTO `sys_dept`
VALUES (103, 101, '0,100,101', '研发部门', 1, 1, '15888888888', 'alphay@qq.com', '0', 0, 'admin', sysdate(), '',
        NULL, NULL);
INSERT INTO `sys_dept`
VALUES (104, 101, '0,100,101', '市场部门', 2, 1, '15888888888', 'alphay@qq.com', '0', 0, 'admin', sysdate(), '',
        NULL, NULL);
INSERT INTO `sys_dept`
VALUES (105, 101, '0,100,101', '测试部门', 3, 1, '15888888888', 'alphay@qq.com', '0', 0, 'admin', sysdate(), '',
        NULL, NULL);
INSERT INTO `sys_dept`
VALUES (106, 101, '0,100,101', '财务部门', 4, 1, '15888888888', 'alphay@qq.com', '0', 0, 'admin', sysdate(), '',
        NULL, NULL);
INSERT INTO `sys_dept`
VALUES (107, 101, '0,100,101', '运维部门', 5, 1, '15888888888', 'alphay@qq.com', '0', 0, 'admin', sysdate(), '',
        NULL, NULL);
INSERT INTO `sys_dept`
VALUES (108, 102, '0,100,102', '市场部门', 1, 1, '15888888888', 'alphay@qq.com', '0', 0, 'admin', sysdate(), '',
        NULL, NULL);
INSERT INTO `sys_dept`
VALUES (109, 102, '0,100,102', '财务部门', 2, 1, '15888888888', 'alphay@qq.com', '0', 0, 'admin', sysdate(), '',
        NULL, NULL);
...
INSERT INTO `sys_dict_data`
VALUES (4, 1, '显示', '0', 'sys_show_hide', '', 'primary', 'Y', '0', 'admin', sysdate(), '', NULL,
        '显示菜单');
INSERT INTO `sys_dict_data`
VALUES (5, 2, '隐藏', '1', 'sys_show_hide', '', 'danger', 'N', '0', 'admin', sysdate(), '', NULL,
        '隐藏菜单');
INSERT INTO `sys_dict_data`
VALUES (6, 1, '正常', '0', 'sys_normal_disable', '', 'primary', 'Y', '0', 'admin', sysdate(), '', NULL,
        '正常状态');
INSERT INTO `sys_dict_data`
VALUES (7, 2, '停用', '1', 'sys_normal_disable', '', 'danger', 'N', '0', 'admin', sysdate(), '', NULL,
        '停用状态');
INSERT INTO `sys_dict_data`
VALUES (8, 1, '正常', '0', 'sys_job_status', '', 'primary', 'Y', '0', 'admin', sysdate(), '', NULL,
        '正常状态');
INSERT INTO `sys_dict_data`
VALUES (9, 2, '暂停', '1', 'sys_job_status', '', 'danger', 'N', '0', 'admin', sysdate(), '', NULL,
        '停用状态');
INSERT INTO `sys_dict_data`
VALUES (10, 1, '默认', 'DEFAULT', 'sys_job_group', '', '', 'Y', '0', 'admin', sysdate(), '', NULL,
        '默认分组');
INSERT INTO `sys_dict_data`
VALUES (11, 2, '系统', 'SYSTEM', 'sys_job_group', '', '', 'N', '0', 'admin', sysdate(), '', NULL,
        '系统分组');
INSERT INTO `sys_dict_data`
VALUES (12, 1, '是', 'Y', 'sys_yes_no', '', 'primary', 'Y', '0', 'admin', sysdate(), '', NULL,
        '系统默认是');
INSERT INTO `sys_dict_data`
VALUES (13, 2, '否', 'N', 'sys_yes_no', '', 'danger', 'N', '0', 'admin', sysdate(), '', NULL, '系统默认否');
INSERT INTO `sys_dict_data`
VALUES (14, 1, '通知', '1', 'sys_notice_type', '', 'warning', 'Y', '0', 'admin', sysdate(), '', NULL,
        '通知');
INSERT INTO `sys_dict_data`
VALUES (15, 2, '公告', '2', 'sys_notice_type', '', 'success', 'N', '0', 'admin', sysdate(), '', NULL,
        '公告');
INSERT INTO `sys_dict_data`
VALUES (16, 1, '正常', '0', 'sys_notice_status', '', 'primary', 'Y', '0', 'admin', sysdate(), '', NULL,
        '正常状态');
INSERT INTO `sys_dict_data`
VALUES (17, 2, '关闭', '1', 'sys_notice_status', '', 'danger', 'N', '0', 'admin', sysdate(), '', NULL,
        '关闭状态');
INSERT INTO `sys_dict_data`
VALUES (18, 99, '其他', '0', 'sys_oper_type', '', 'info', 'N', '0', 'admin', sysdate(), '', NULL,
        '其他操作');
INSERT INTO `sys_dict_data`
VALUES (19, 1, '新增', '1', 'sys_oper_type', '', 'info', 'N', '0', 'admin', sysdate(), '', NULL,
        '新增操作');
INSERT INTO `sys_dict_data`
VALUES (20, 2, '修改', '2', 'sys_oper_type', '', 'info', 'N', '0', 'admin', sysdate(), '', NULL,
        '修改操作');
INSERT INTO `sys_dict_data`
VALUES (21, 3, '删除', '3', 'sys_oper_type', '', 'danger', 'N', '0', 'admin', sysdate(), '', NULL,
        '删除操作');
INSERT INTO `sys_dict_data`
VALUES (22, 4, '授权', '4', 'sys_oper_type', '', 'primary', 'N', '0', 'admin', sysdate(), '', NULL,
        '授权操作');
INSERT INTO `sys_dict_data`
VALUES (23, 5, '导出', '5', 'sys_oper_type', '', 'warning', 'N', '0', 'admin', sysdate(), '', NULL,
        '导出操作');
INSERT INTO `sys_dict_data`
VALUES (24, 6, '导入', '6', 'sys_oper_type', '', 'warning', 'N', '0', 'admin', sysdate(), '', NULL,
        '导入操作');
INSERT INTO `sys_dict_data`
VALUES (25, 7, '强退', '7', 'sys_oper_type', '', 'danger', 'N', '0', 'admin', sysdate(), '', NULL,
        '强退操作');
INSERT INTO `sys_dict_data`
VALUES (26, 8, '生成代码', '8', 'sys_oper_type', '', 'warning', 'N', '0', 'admin', sysdate(), '', NULL,
        '生成操作');
INSERT INTO `sys_dict_data`
VALUES (27, 9, '清空数据', '9', 'sys_oper_type', '', 'danger', 'N', '0', 'admin', sysdate(), '', NULL,
        '清空操作');
INSERT INTO `sys_dict_data`
VALUES (28, 1, '成功', '0', 'sys_common_status', '', 'primary', 'N', '0', 'admin', sysdate(), '', NULL,
        '正常状态');
INSERT INTO `sys_dict_data`
VALUES (29, 2, '失败', '1', 'sys_common_status', '', 'danger', 'N', '0', 'admin', sysdate(), '', NULL,
        '停用状态');
INSERT INTO `sys_dict_data`
VALUES (30, 0, '默认', '0', 'bpm_model_category', NULL, 'primary', 'Y', '0', 'admin', sysdate(), '', NULL,
        '流程分类 - 默认');
INSERT INTO `sys_dict_data`
VALUES (31, 1, 'OA', '1', 'bpm_model_category', NULL, 'danger', 'N', '0', 'admin', sysdate(), '', NULL,
        '流程分类 - OA');
INSERT INTO `sys_dict_data`
VALUES (32, 3, '流程发起人的二级领导', '21', 'bpm_task_assign_script', NULL, 'default', 'N', '0', 'admin',
        sysdate(), '', null, '任务分配自定义脚本 - 流程发起人的二级领导');
INSERT INTO `sys_dict_data`
VALUES (33, 2, '流程发起人的一级领导', '20', 'bpm_task_assign_script', NULL, 'default', 'N', '0', 'admin',
        sysdate(), '', NULL, '任务分配自定义脚本 - 流程发起人的一级领导');
INSERT INTO `sys_dict_data`
VALUES (34, 1, '流程发起人', '10', 'bpm_task_assign_script', NULL, 'default', 'N', '0', 'admin', sysdate(),
        '', NULL, '任务分配自定义脚本 - 流程发起人');
INSERT INTO `sys_dict_data`
VALUES (35, 1, '角色', '10', 'bpm_task_assign_rule_type', NULL, 'info', 'N', '0', 'admin', sysdate(), '',
        NULL, '任务分配规则的类型 - 角色');
INSERT INTO `sys_dict_data`
VALUES (36, 2, '部门的成员', '20', 'bpm_task_assign_rule_type', NULL, 'primary', 'N', '0', 'admin',
        sysdate(), '', NULL, '任务分配规则的类型 - 部门的成员');
INSERT INTO `sys_dict_data`
VALUES (37, 3, '部门的负责人', '21', 'bpm_task_assign_rule_type', NULL, 'primary', 'N', '0', 'admin',
        sysdate(), '', NULL, '任务分配规则的类型 - 部门的负责人');
INSERT INTO `sys_dict_data`
VALUES (38, 4, '岗位', '22', 'bpm_task_assign_rule_type', NULL, 'success', 'N', '0', 'admin', sysdate(),
        '', NULL, '任务分配规则的类型 - 岗位');
INSERT INTO `sys_dict_data`
VALUES (39, 5, '用户', '30', 'bpm_task_assign_rule_type', NULL, 'info', 'N', '0', 'admin', sysdate(), '',
        NULL, '任务分配规则的类型 - 用户');
INSERT INTO `sys_dict_data`
VALUES (40, 6, '用户组', '40', 'bpm_task_assign_rule_type', NULL, 'warning', 'N', '0', 'admin', sysdate(),
        '', NULL, '任务分配规则的类型 - 用户组');
INSERT INTO `sys_dict_data`
VALUES (41, 7, '自定义脚本', '50', 'bpm_task_assign_rule_type', NULL, 'danger', 'N', '0', 'admin',
        sysdate(), '', NULL, '任务分配规则的类型 - 自定义脚本');
INSERT INTO `sys_dict_data`
VALUES (42, 1, '流程表单', '10', 'bpm_model_form_type', NULL, 'default', 'N', '0', 'admin', sysdate(), '',
        NULL, '流程的表单类型 - 流程表单');
INSERT INTO `sys_dict_data`
VALUES (43, 2, '业务表单', '20', 'bpm_model_form_type', NULL, 'default', 'N', '0', 'admin', sysdate(), '',
        NULL, '流程的表单类型 - 业务表单');
INSERT INTO `sys_dict_data`
VALUES (44, 0, '处理中', '1', 'bpm_process_instance_result', NULL, 'primary', 'N', '0', 'admin', sysdate(),
        '', NULL, '流程实例的结果 - 处理中');
INSERT INTO `sys_dict_data`
VALUES (45, 2, '通过', '2', 'bpm_process_instance_result', NULL, 'success', 'N', '0', 'admin', sysdate(),
        '', NULL, '流程实例的结果 - 通过');
INSERT INTO `sys_dict_data`
VALUES (46, 3, '不通过', '3', 'bpm_process_instance_result', NULL, 'danger', 'N', '0', 'admin', sysdate(),
        '', NULL, '流程实例的结果 - 不通过');
INSERT INTO `sys_dict_data`
VALUES (47, 4, '已取消', '4', 'bpm_process_instance_result', NULL, 'info', 'N', '0', 'admin', sysdate(),
        '', NULL, '流程实例的结果 - 已取消');
INSERT INTO `sys_dict_data`
VALUES (48, 1, '进行中', '1', 'bpm_process_instance_status', NULL, 'primary', 'N', '0', 'admin', sysdate(),
        '', NULL, '流程实例的状态 - 进行中');
INSERT INTO `sys_dict_data`
VALUES (49, 2, '已完成', '2', 'bpm_process_instance_status', NULL, 'success', 'N', '0', 'admin', sysdate(),
        '', NULL, '流程实例的状态 - 已完成');
...
INSERT INTO `sys_dict_type`
VALUES (11, '流程分类', 'bpm_model_category', '0', 'admin', sysdate(), '', NULL, '流程分类列表');
INSERT INTO `sys_dict_type`
VALUES (12, '任务分配自定义脚本', 'bpm_task_assign_script', '0', 'admin', sysdate(), '', null,
        '任务分配自定义脚本列表');
INSERT INTO `sys_dict_type`
VALUES (13, '任务分配规则的类型', 'bpm_task_assign_rule_type', '0', 'admin', sysdate(), '', NULL,
        '任务分配规则的类型列表');
INSERT INTO `sys_dict_type`
VALUES (14, '流程的表单类型', 'bpm_model_form_type', '0', 'admin', sysdate(), '', NULL, '流程的表单类型列表');
INSERT INTO `sys_dict_type`
VALUES (15, '流程实例的结果', 'bpm_process_instance_result', '0', 'admin', sysdate(), '', NULL, '流程实例的结果列表');
INSERT INTO `sys_dict_type`
VALUES (16, '流程实例的状态', 'bpm_process_instance_status', '0', 'admin', sysdate(), '', NULL, '流程实例的状态列表');
...
VALUES (2000, '动态表单构建', 3, 4, NULL, 'build2', 'tool/build2/index', NULL, 1, 0, 'C', '0', '0', 'tool:build:list',
        'build', 'admin', sysdate(), '', NULL, '', 0);
INSERT INTO `sys_menu`
VALUES (2001, '系统设置', 1, 7, NULL, 'setting', 'system/setting/index', NULL, 1, 0, 'C', '0', '0',
        'system:config:list', 'system', 'admin', sysdate(), '', NULL, '', 0);
INSERT INTO `sys_menu`
...
VALUES (2003, '业务流表单', 2010, 1, NULL, 'bpmForm', 'bpm/bpmForm/index', NULL, 1, 0, 'C', '0', '0',
        'bpm:bpmForm:list', 'dict', 'admin', sysdate(), '', NULL, '', 0);
INSERT INTO `sys_menu`
...
VALUES (2009, '流程表单设计', 2010, 6, 'BpmFormDesign', 'design/:id', 'bpm/bpmForm/edit', NULL, 1, 0, 'C', '1', '0',
        'bpm:bpmForm:add,bpm:bpmForm:edit', 'build', 'admin', sysdate(), '', NULL, '', 0);
INSERT INTO `sys_menu`
...
VALUES (2011, '流程模型', 2010, 2, NULL, 'model', 'bpm/model/index', NULL, 1, 0, 'C', '0', '0', 'bpm:bpmModel:list',
        'guide', 'admin', sysdate(), '', NULL, '', 0);
INSERT INTO `sys_menu`
VALUES (2012, '流程定义', 2010, 7, NULL, 'definition', 'bpm/definition/index', NULL, 1, 0, 'C', '1', '0',
        'bpm:definition:list', '#', 'admin', sysdate(), '', NULL, '', 0);
INSERT INTO `sys_menu`
VALUES (2013, '流程设计', 2010, 8, NULL, 'model/design', 'bpm/model/modelEditor', NULL, 1, 0, 'C', '1', '0',
        'bpm:bpmModel:design', '#', 'admin', sysdate(), '', NULL, '', 0);
INSERT INTO `sys_menu`
VALUES (2014, '用户分组', 2010, 3, NULL, 'userGroup', 'bpm/group/index', NULL, 1, 0, 'C', '0', '0',
        'bpm:userGroup:list', 'peoples', 'admin', sysdate(), '', NULL, '', 0);
INSERT INTO `sys_menu`
...
VALUES (2019, '发起流程', 2015, 4, NULL, 'create', 'bpm/processInstance/create', NULL, 1, 0, 'C', '1', '0',
        'bpm:processInstance:create', '#', 'admin', sysdate(), '', NULL, '', 0);
INSERT INTO `sys_menu`
VALUES (2020, '流程信息', 2015, 5, NULL, 'detail', 'bpm/processInstance/detail', NULL, 1, 0, 'C', '1', '0',
        'bpm:processInstance:info', '#', 'admin', sysdate(), '', NULL, '', 0);
...
VALUES (1, '温馨提醒：2018-07-01 D3code新版本发布啦', '2', 0xE696B0E78988E69CACE58685E5AEB9, '0', 'admin',
        sysdate(), '', NULL, '管理员');
INSERT INTO `sys_notice`
VALUES (2, '维护通知：2018-07-01 D3code系统凌晨维护', '1', 0xE7BBB4E68AA4E58685E5AEB9, '0', 'admin', sysdate(),
        '', NULL, '管理员');
...
VALUES (1, sysdate(), 'admin', null, '', 0, 103, 'admin', 'Alphay', '00', 'ry@q163.com',
        '15888888888', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '127.0.0.1',
        sysdate(), '管理员');
INSERT INTO `sys_user`
VALUES (2, sysdate(), 'admin', NULL, '', 0, 105, 'ry', 'Alphay', '00', 'ry@qq.com', '15666666666', '1', '',
        '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '127.0.0.1', sysdate(),
        '测试员');
