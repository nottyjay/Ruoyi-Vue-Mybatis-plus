...
import com.alphay.boot.common.exception.file.FileNameLengthLimitExceededException;
import com.alphay.boot.common.exception.file.FileSizeLimitExceededException;
import com.alphay.boot.common.exception.file.InvalidExtensionException;
...
public class FileUploadUtils {
  ...
  public static final String upload(String baseDir, MultipartFile file, String[] allowedExtension)
    ...
    StorageEngine storageEngine = StorageEngineUtil.getInstance();
    return storageEngine.uploadFileSync(file, fileName);
  }
